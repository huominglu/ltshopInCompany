...
<section class="content-wrapper">
	<div class="content-container container">
		...
		<c:if test="${currentpageno>0}">
			<a  href="getprodbysubtypepage?currentpageno=0&pagesize=${pagesize}"  target="_self" >首页</a>  
			<a  href="getprodbysubtypepage?currentpageno=${currentpageno-1}&pagesize=${pagesize}"  target="_self" >上一页</a>
		</c:if>	  			
		<c:if test="${currentpageno==0}"> 首页 &nbsp;上一页</c:if>
		<c:if test="${currentpageno < totalpage-1}">			
			<a  href="getprodbysubtypepage?currentpageno=${currentpageno+1}&pagesize=${pagesize}"  target="_self" >下一页</a>  
			<a  href="getprodbysubtypepage?currentpageno=${totalpage-1}&pagesize=${pagesize}"  target="_self" >尾页</a>		
		</c:if> 
