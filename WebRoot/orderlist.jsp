        ...
        <div class="content-container container">
            ...
            <div  class="col-main">
                <div class="contact-form-container">
                    ...
                    <table>
                       ...
                       <c:if test="${fn:length(pm.datas)>0 }">
                		<c:forEach items="${pm.datas }" var="order">
                			<c:if test="${sessionScope.user.username == order.username }">               			
		                        <tr>
		                            ...
		                            <td>
		                            <a href="ordetail1?order.id=${order.id }" class="inline">
		                            	详情
		                            </a>
		                            </td>
		                        </tr>
		            ...
		            <pg:pager items="${pm.total }" url="listorder1.action" export="currentPageNumber=pageNumber">
		                <pg:first>
		                    <a href="${pageUrl}">首页</a>
		                </pg:first>
		                <pg:prev>
